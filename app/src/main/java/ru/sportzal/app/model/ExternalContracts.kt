...
@Serializable data class BlockDocument(@SerialName("block_id") val blockId:String, val title:String, val mode:String,
 val exercises:List<ExerciseDocument>, @EncodeDefault(EncodeDefault.Mode.NEVER) val notes:String?=null)
@Serializable data class ExerciseDocument(@SerialName("exercise_instance_id") val exerciseInstanceId:String,
 ...
 @SerialName("planned_sets") val plannedSets:List<PlannedSetDocument>, @EncodeDefault(EncodeDefault.Mode.NEVER) val notes:String?=null)
